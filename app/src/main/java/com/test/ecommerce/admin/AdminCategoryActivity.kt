...
import com.test.ecommerce.HomeActivity
...
class AdminCategoryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.sportsTShirts.setOnClickListener { startActivity(Intent(this,
            AdminAddNewProductActivity::class.java).putExtra("category","sportdTShirt")) }
        binding.femaleDresses.setOnClickListener { startActivity(Intent(this,
            AdminAddNewProductActivity::class.java).putExtra("category","femaleDresses")) }
        binding.sweathers.setOnClickListener { startActivity(Intent(this,
            AdminAddNewProductActivity::class.java).putExtra("category","sweathers")) }
        ...
        binding.hatsCaps.setOnClickListener { startActivity(Intent(this,
            AdminAddNewProductActivity::class.java).putExtra("category","hatsCaps")) }
        binding.pursesBagsWallets.setOnClickListener { startActivity(Intent(this,
            AdminAddNewProductActivity::class.java).putExtra("category","wallets bags purses")) }
        ...
        binding.headphonesHandfree.setOnClickListener { startActivity(Intent(this,
            AdminAddNewProductActivity::class.java).putExtra("category","Head Phones Hand Free")) }
        binding.laptopPc.setOnClickListener { startActivity(Intent(this,
            AdminAddNewProductActivity::class.java).putExtra("category","Laptops")) }
        ...
        binding.mobilephones.setOnClickListener { startActivity(Intent(this,
            AdminAddNewProductActivity::class.java).putExtra("category","Mobile Phones")) }
